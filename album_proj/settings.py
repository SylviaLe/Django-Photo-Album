"""
Django settings for album_proj project.
...
SECRET_KEY = os.getenv('ALBUM_KEY')
...
WSGI_APPLICATION = 'album_proj.wsgi.application'
...
MEDIA_URL = '/images/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'static', 'images')  #tell where to upload the files to
